...
const SearchImage = ({ searchtext }) => {
  ...
  return (
    ...
    <form onSubmit={onSubmit} className="w-full max-w-sm">
      ...
      <input onChange={e => setText(e.target.value)} className="appearance-none bg-transparent border-black w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" placeholder="Search an Image..." />
